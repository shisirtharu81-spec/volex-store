          ...
          >
            ...
            {invoice ? (
              ...
              <div className="flex-grow overflow-y-auto py-4 space-y-4 pr-1">
                ...
                {/* Payment Method Selector (Only show if cart has items) */}
                {cartItems.length > 0 && (
                  <div className="border-t border-purple-500/10 pt-4">
                    <span className="text-[10px] font-mono font-black text-gray-500 uppercase tracking-widest block mb-2.5">
                      SECURE CHECKOUT CHANNEL
                    </span>
                    <div className="grid grid-cols-4 gap-1.5">
                      <button
                        type="button"
                        onClick={() => setPaymentMethod('stripe')}
                        className={`flex flex-col items-center justify-center p-2 rounded-xl border font-sans uppercase text-[8px] font-bold transition-all cursor-pointer ${
                          paymentMethod === 'stripe'
                            ? 'bg-purple-500/15 border-purple-500/50 text-white shadow-[0_0_10px_rgba(168,85,247,0.1)]'
                            : 'bg-black/40 border-purple-500/5 text-gray-500 hover:text-gray-300 hover:border-purple-500/10'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded-xl border font-sans uppercase text-[8px] font-bold transition-all cursor-pointer ${
                          paymentMethod === 'razorpay'
                            ? 'bg-cyan-500/15 border-cyan-500/50 text-white shadow-[0_0_10px_rgba(6,182,212,0.1)]'
                            : 'bg-black/40 border-purple-500/5 text-gray-500 hover:text-gray-300 hover:border-purple-500/10'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded-xl border font-sans uppercase text-[8px] font-bold transition-all cursor-pointer ${
                          paymentMethod === 'upi'
                            ? 'bg-amber-500/15 border-amber-500/50 text-white shadow-[0_0_10px_rgba(245,158,11,0.1)]'
                            : 'bg-black/40 border-purple-500/5 text-gray-500 hover:text-gray-300 hover:border-purple-500/10'
                        }`}
                      >
                        <CheckCircle className="h-4 w-4 mb-1 text-amber-400" />
                        <span>UPI Pay</span>
                      </button>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded-xl border font-sans uppercase text-[8px] font-bold transition-all cursor-pointer ${
                          paymentMethod === 'tebex'
                            ? 'bg-emerald-500/15 border-emerald-500/50 text-white shadow-[0_0_10px_rgba(16,185,129,0.1)]'
                            : 'bg-black/40 border-purple-500/5 text-gray-500 hover:text-gray-300 hover:border-purple-500/10'
                        }`}
                      >
                        <Terminal className="h-4 w-4 mb-1 text-emerald-400" />
                        <span>Tebex API</span>
                      </button>
                    </div>
                  </div>
